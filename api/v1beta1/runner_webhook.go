...
// +kubebuilder:webhook:verbs=create;update,path=/validate-apps-gitlab-com-v1beta1-runner,mutating=false,failurePolicy=fail,groups=apps.gitlab.com,resources=runners,versions=v1beta1,name=vrunner.kb.io
...
func (r *Runner) ValidateCreate() error {
	...
	if r.Spec.GitLab.Name == "" && r.Spec.GitLab.URL == "" {
		return errors.New("spec.gitlab.url is empty")
	}
