...
// Template represents a Helm template and provides methods to query and edit objects that are loaded
// from the after rendering it.
...
func (t *mutableTemplate) Query() Query {
	return t.query
}
