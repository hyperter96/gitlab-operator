...
1. Deploy the GitLab Operator.
   ...
   ```shell
   GL_OPERATOR_VERSION=0.6.1 # https://gitlab.com/gitlab-org/cloud-native/gitlab-operator/-/releases
...
1. Create a GitLab custom resource (CR).
   ...
   spec:
     chart:
       version: "X.Y.Z" # https://gitlab.com/gitlab-org/cloud-native/gitlab-operator/-/blob/0.6.1/CHART_VERSIONS
       values:
         global:
           hosts:
