...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ServicesHealth) DeepCopyInto(out *ServicesHealth) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ServicesHealth.
func (in *ServicesHealth) DeepCopy() *ServicesHealth {
	if in == nil {
		return nil
	}
	out := new(ServicesHealth)
	in.DeepCopyInto(out)
	return out
}
